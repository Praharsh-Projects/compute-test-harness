...
build:
	...
	cc -O2 -std=c11 -Wall -Wextra workloads/matrix_multiply.c -o workloads/bin/matrix_multiply
	cc -O2 -std=c11 -Wall -Wextra workloads/memory_bandwidth.c -o workloads/bin/memory_bandwidth
	cc -O2 -std=c11 -Wall -Wextra workloads/vector_add.c -o workloads/bin/vector_add
